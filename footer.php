            ...
            <div class="col-xl-4 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="contact-info">
                        ...
                        <li>
                            <a href="tel:<?php echo $company_phonenumber; ?>"><?php echo $company_phonenumber; ?></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="properties.php">Property Listing</a>
                        </li>
                        <li>
...
<div class="sub-footer">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <p class="copy">© <?php echo date("Y"); ?> <a href="index.php"><?php echo $company_name; ?></a> | Designed by <a href="www.linkedin.com/in/chrysanthus-obinna">Chrysanthus.C.</a> </p>
            </div>
        </div>
    </div>
</div>
